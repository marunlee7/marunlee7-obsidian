...
publish_date: `${new Date(+/* @__PURE__ */ new Date() + 3240 * 1e4).toISOString().split("T")[0] + " " + (/* @__PURE__ */ new Date()).toTimeString().split(" ")[0].slice(0, 5)}`,      
      created: `${new Date(+/* @__PURE__ */ new Date() + 3240 * 1e4).toISOString().split("T")[0]}`,
      modified: `${new Date(+/* @__PURE__ */ new Date() + 3240 * 1e4).toISOString().split("T")[0]}`,
      title: `${title}`,
      author: `${author.join(", ")}`,
      category: `${tag[1]}`,
      total_page: page,      
...
${toggleTitle ? `# ${title}` : ""}${toggleIntroduction ? `
