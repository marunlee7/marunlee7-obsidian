...
## 오늘 작성한 노트
```dataview
List FROM "" WHERE file.cday = date("2025-06-15") SORT file.ctime desc
limit 5
```
## 오늘 수정한 노트
```dataview
List FROM "" WHERE file.mday = date("2025-06-15") SORT file.mtime desc
limit 5
```