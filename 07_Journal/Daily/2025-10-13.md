...
- :: 책읽기 + 클리핑 + 코딩 <br>코딩 수정 및 적용은 원페이지 정리로 마무리 할 것. 

## 오늘 끝내야 할 일
```tasks
due on or before 2025-10-13
...
## 오늘 작성한 노트
```dataview
List FROM "" WHERE file.cday = date("2025-10-13") SORT file.ctime desc
limit 5
```
## 오늘 수정한 노트
```dataview
List FROM "" WHERE file.mday = date("2025-10-13") SORT file.mtime desc
limit 5
```