...
- [ ] [[B-최성엽의 실용한자]] 이미지 정리 및 폴더 넣기 📅 2025-10-07 
...
## 오늘 작성한 노트
```dataview
List FROM "" WHERE file.cday = date("2025-10-02") SORT file.ctime desc
limit 5
```
## 오늘 수정한 노트
```dataview
List FROM "" WHERE file.mday = date("2025-10-02") SORT file.mtime desc
limit 5
```