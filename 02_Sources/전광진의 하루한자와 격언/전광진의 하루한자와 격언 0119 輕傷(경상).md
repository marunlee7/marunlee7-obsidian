---
raw_published: "데스크  | 입력 :  2018/07/14 [14:54]"
published:
aliases: ["전광진의 '하루한자와 격언'[119 輕傷(경상)"]
title: 전광진의 하루한자와 격언 0119 輕傷(경상)
level: T02
...
priority: "medium"
process: "raw"
source_name: 전광진의 하루한자와 격언 0119 輕傷(경상)
source_author: "전광진"
source_type: article
action_required: deep_dive
difficulty: good
satisfaction: 3
references: "https://www.ggdaily.kr/sub_read.html?uid=83893&section=sc66&section2="
...
輕자는 ‘가벼운 수레’(輕車, light cart)란 뜻을 나타내기 위한 것이었으니 ‘수레 거’(車)가 의미요소로 쓰였고, 巠(경)은 발음요소이다. 후에 ‘가볍다’(light)는 뜻으로 확대 사용됐다.
...
‘신체, 머리, 피부는 부모님께 받은 것이니 그것을 손상시키지 않는 것이 효도의 시작이다’

(身體髮膚신체발부, 受之父母수지부모, 不敢毁傷불감훼상, 孝之始也효지시야 - ‘孝經’효경).
