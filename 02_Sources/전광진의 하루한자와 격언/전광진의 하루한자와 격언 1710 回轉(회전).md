---
raw_published: "데스크  | 입력 :  2024/09/09 [08:01]"
published:
aliases: ["전광진의 '하루한자와 격언'[1710 回轉(회전)"]
title: 전광진의 하루한자와 격언 1710 回轉(회전)
level: T02
...
priority: "medium"
process: "raw"
source_name: 전광진의 하루한자와 격언 1710 回轉(회전)
source_author: "전광진"
source_type: article
action_required: deep_dive
difficulty: good
satisfaction: 3
references: "https://www.ggdaily.kr/sub_read.html?uid=120304&section=sc66&section2="
...
‘He is quick on the uptake.’는 ‘그는 머리의 ○○이 빠르다’는 뜻이다. 공란에 적절한 말은? ①回轉 ②回傳 ③回電 ④悔悛. 답인 ‘回轉’에 대하여 빙빙 겉돌지 말고 확실하게 알아보자. 한자는 속을 훤히 볼 수 있다는 장점이 있다. 
...
回轉(=廻轉)은 ‘돌고\[回\] 구름\[轉\]’이 속뜻인데, ‘어떤 것을 축으로 물체 자체가 빙빙 돎’ 등을 이른다. 경제학에서는 ‘투자한 자금이 모두 걷히는 기간’이라 정의하기도 한다.

선(善)은 따를수록 좋고, 악(惡)은 버릴수록 좋다. 아래 명언을 잘 음미해 보자. 중국 북제 때 저명 사상가 유주란 선비가 남긴 명언을 우리말로 옮긴 것이다. 
