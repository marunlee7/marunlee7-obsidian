---
raw_published: "데스크  | 입력 :  2019/01/04 [10:51]"
published:
aliases: ["전광진의 '하루한자와 격언'[256冷靜(냉정)"]
title: 전광진의 하루한자와 격언 0256 冷靜(냉정)
level: T02
...
priority: "medium"
process: "raw"
source_name: 전광진의 하루한자와 격언 0256 冷靜(냉정)
source_author: "전광진"
source_type: article
action_required: deep_dive
difficulty: good
satisfaction: 3
references: "https://www.ggdaily.kr/sub_read.html?uid=85991&section=sc66&section2="
...
‘아무도 이런 충격을 받고도 냉정할 수는 없다’의 ‘냉정’은? ①冷情 ②冷靜 ③冷淨 ④冷精. ‘冷靜’이란 두 글자는?

冷자는 ‘차갑다’(icy)는 뜻을 나타내기 위한 글자였으니, ‘얼음 빙’(冫)이 의미요소로 발탁됐다. 냉면 그릇에 띄워 놓은 두 개의 얼음 덩어리가 연상된다. 令(명령 령)은 발음요소다. ‘맑다’(clear) ‘깨끗하다’(clean) 등으로도 쓰인다.
