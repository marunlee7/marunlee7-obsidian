---
raw_published: "데스크  | 입력 :  2018/12/22 [15:37]"
published:
aliases: ["전광진의 '하루한자와 격언'[246 本錢(본전)"]
title: 전광진의 하루한자와 격언 0246 本錢(본전)
level: T02
...
priority: "medium"
process: "raw"
source_name: 전광진의 하루한자와 격언 0246 本錢(본전)
source_author: "전광진"
source_type: article
action_required: link_to_t04
difficulty: good
satisfaction: 3
references: "https://www.ggdaily.kr/sub_read.html?uid=85831&section=sc66&section2="
...
本자는 ‘나무 목’(木)과 ‘一’이 합쳐진 것이다. 여기에서 ‘一’은 ‘하나’를 뜻하는 것이 글자가 아니라, 나무 뿌리의 위치를 가리키는 부호에 불과한 것이다. ‘나무뿌리’(the root of a tree)가 본뜻인데, ‘책’(book) ‘문서’(document) ‘밑천’(capital)같은 뜻으로도 쓰인다.

錢자는 구리돈, 즉 ‘동전’(copper coin)을 뜻하는 것이니 ‘쇠 금’(金)이 의미요소로 쓰였다. 戔(쌓일 전)은 발음요소일 따름이다. 후에 ‘돈’(돈)을 이르는 것으로 확대 사용됐다.

本錢은 ‘본래(本來) 가지고 있던 돈\[錢\]’, ‘장사나 사업의 밑천’을 이른다. 수(隋)나라 왕통의 명언을 들어보자.

‘권력으로 사귄 자는 권력이 기울면 떠나가고, 이득으로 사귄 자는 이득이 적어지면 흩어진다.’ (以勢交者 이세교자, 勢傾則絶 세경즉절;  以利交者이이교자, 利窮則散이궁즉산.    - 王通의 ‘文中子’).
