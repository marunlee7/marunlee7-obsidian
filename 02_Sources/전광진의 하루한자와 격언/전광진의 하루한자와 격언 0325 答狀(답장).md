---
raw_published: "데스크  | 입력 :  2019/04/15 [09:07]"
published:
aliases: ["전광진 교수의 '하루한자와 격언'[325 答 狀(답장)"]
title: 전광진의 하루한자와 격언 0325 答狀(답장)
level: T02
...
priority: "medium"
process: "raw"
source_name: 전광진의 하루한자와 격언 0325 答狀(답장)
source_author: "전광진"
source_type: article
action_required: deep_dive
difficulty: good
satisfaction: 3
references: "https://www.ggdaily.kr/sub_read.html?uid=87397&section=sc66&section2="
...
‘답장을 보내다/답장을 쓰다/답장이 오다’의 ‘답장’은? ①合壯 ②答壯 ③答狀 ④合狀. ‘答狀’에 대해 답해 본다.
...
狀자는 ‘형상’(shape)이란 뜻을 나타내기 위해서 나무 판자\[爿․장\] 위에 올라가 있는 개\[犬․견\]의 모습을 본뜬 것이다. 발상이 참으로 이채롭고 재미있다. ‘문서’(document)나 ‘편지’(letter)를 뜻할 때에는 \[장\]으로 읽는다.
