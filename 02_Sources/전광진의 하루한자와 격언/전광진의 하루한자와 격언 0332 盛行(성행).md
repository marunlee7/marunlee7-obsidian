---
raw_published: "데스크  | 입력 :  2019/04/22 [10:39]"
published:
aliases: ["전광진 교수의 '하루한자와 격언'[332盛行(성행)"]
title: 전광진의 하루한자와 격언 0332 盛行(성행)
level: T02
...
priority: "medium"
process: "raw"
source_name: 전광진의 하루한자와 격언 0332 盛行(성행)
source_author: "전광진"
source_type: article
action_required: deep_dive
difficulty: good
satisfaction: 3
references: "https://www.ggdaily.kr/sub_read.html?uid=87496&section=sc66&section2="
...
‘초등학교까지 번진 과소비의 성행은 참으로 걱정스럽다’의 ‘성행’은? ①星行 ②盛行 ③聖行 ④性行. ‘盛行’이란?

盛자는 ‘그릇’(vessel)을 뜻하기 위한 것이었으니 ‘그릇 명’(皿)이 의미요소로 쓰였고, 成(이룰 성)은 발음요소다. 후에 ‘담다’(fill) ‘가득 차다’(become full) ‘성하다’(flourish) 등으로 확대 사용됐다.

行자가 ‘조금 걸을 척’(彳)과 ‘자축거릴 촉’(亍)이 조합된 것이라는 설은 문제가 있는 것이다.

원래 이 글자는 ‘네거리’ 모양을 본뜬 것이었음은 갑골 문자에서 똑똑히 볼 수 있다. ‘네거리’(crossroads)가 본뜻인데, ‘길거리’(road) ‘다니다’(go to and from) ‘하다’(do) 등으로 확대 사용됐다.

盛行(성:행)은 ‘매우 왕성(旺盛)하게 널리 행(行)하여짐’을 이른다.

자고로, ‘해는 한낮이 되면 지기 시작하고,  달은 차면 이지러지고,  사물은 성하면 쇠하기 마련이다.’  
