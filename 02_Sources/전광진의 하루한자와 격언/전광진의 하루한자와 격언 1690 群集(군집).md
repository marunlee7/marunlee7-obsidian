---
raw_published: "2024/08/12 [08:03]"
published:
aliases: [전광진의 하루한자와 격언 1690 群集(군집)]
title: 전광진의 하루한자와 격언 1690 群集(군집)
level: T02
...
priority: "medium"
process: "raw"
source_name: 전광진의 하루한자와 격언 1690 群集(군집)
source_author: "전광진"
source_type: article
action_required: deep_dive
difficulty: good
satisfaction: 3
references: "https://www.ggdaily.kr/sub_read.html?uid=119509&section=sc66&section2="
...
群集은 ‘사람이나 동물 따위가 한곳에 떼\[群\]를 지어 모임\[集\]’이 속뜻인데, 생물학적으로는 ‘여러 종류의 생물이 자연계의 한 지역에 살면서 유기적인 관계를 가지고 생활하는 개체군의 모임’이라 정의한다. 학술적 정의는 대개 길고 어렵다. 짧고 명료한 속뜻을 알면 쉽게 이해하고 기억할 수 있다. 

시를 잘 쓰는 호걸이라는 뜻인 ‘시호’(詩豪)란 별명을 얻은 당나라 저명 시인 유우석(772-842)이 남긴 명언이 많다. 그 가운데 하나를 아래에 소개해 본다. 맨 앞 문제에 대한 답이 들어 있다. 험담이 중상모략으로 발전되지 않도록 미리미리 대비해야 한다. 
