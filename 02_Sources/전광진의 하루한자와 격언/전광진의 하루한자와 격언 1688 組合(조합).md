---
raw_published: "2024/08/08 [08:15]"
published:
aliases: [전광진의 하루한자와 격언 1688 組合(조합)]
title: 전광진의 하루한자와 격언 1688 組合(조합)
level: T02
...
priority: "medium"
process: "raw"
source_name: 전광진의 하루한자와 격언 1688 組合(조합)
source_author: "전광진"
source_type: article
action_required: deep_dive
difficulty: good
satisfaction: 3
references: "https://www.ggdaily.kr/sub_read.html?uid=119418&section=sc66&section2="
...
법률 용어로는 ‘두 사람 이상이 출자하여 공동 사업을 경영하기 위하여 결합한 단체’를 이르기도 하는 것은? ①組合 ②組織 ③組員 ④勞組. 답인 ‘組合’에 대해 차근차근 알뜰살뜰 살펴보자. 
...
組合은 ‘여럿을 한데 엮어\[組\] 한 덩어리로 합(合)함’을 이른다. ‘합할 합(合)’자가 들어간 명언을 어렵사리 찾게 되어 아래에 소개해 본다. 당나라 저명 문학자 한유(韓愈, 768-824)가 한 말이다. 仁과 義만 알아도 더불어 살아가는 세상을 너끈하게 살 수 있다는 속뜻이 담겨 있는 듯! 

“이른바 도덕이라고 말하는 것은 

 인(仁)과 의(義)를 합해서 말하는 것이다.”
