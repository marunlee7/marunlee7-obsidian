---
raw_published: "데스크  | 입력 :  2018/01/30 [13:48]"
published:
aliases: [전광진의 하루한자와 격언 0005 不足(부족)]
title: 전광진의 하루한자와 격언 0005 不足(부족)
level: T02
...
priority: "medium"
process: "raw"
source_name: 전광진의 하루한자와 격언 0005 不足(부족)
source_author: "전광진"
source_type: article
action_required: deep_dive
difficulty: good
satisfaction: 3
references: "https://www.ggdaily.kr/sub_read.html?uid=81968&section=sc66&section2="
...
일반 국어사전에서 ‘필요한 양이나 기준에 미치지 못해 충분하지 아니함’이라 풀이한 ‘부족’이란 한자어는 수박과 같은 점이 있다. ‘不足’이라 써서 그 속을 파헤쳐 봐야 비로소...  
  
不자의 자형 풀이에 대해서는 여러 설들이 많은데, 모두 확실한 증거가 없다. 획수가 매우 적으니 그냥 외워 버리는 것이 상책이다. ‘아니다’(not)는 뜻의 부정사로 쓰이며, 그 뒤 글자의 자음이 /ㄷ/이나 /ㅈ/일 때에는 \[부\]로 읽는다.  
...
  衆不附者, 仁不足也(중불부자, 인부족야);  
  附而不治者, 義不足也(부이불치자, 의부족야) - ‘三國志注(삼국지주)’).

‘스스로 만족함을 알면 욕되지 않고,

분에 맞게 머물 줄 알면 위태롭지 않다’

知足不辱 知止不殆(지족불욕 지지불태). \-老子(노자)의 道德經(도덕경)-
