---
raw_published: "데스크  | 입력 :  2018/12/03 [12:22]"
published:
aliases: ["전광진의 '하루한자와 격언'[230 證券(증권)"]
title: 전광진의 하루한자와 격언 0230 證券(증권)
level: T02
...
priority: "medium"
process: "raw"
source_name: 전광진의 하루한자와 격언 0230 證券(증권)
source_author: "전광진"
source_type: article
action_required: deep_dive
difficulty: good
satisfaction: 3
references: "https://www.ggdaily.kr/sub_read.html?uid=85562&section=sc66&section2="
...
‘주식․공채․사채 등의 유가 증권’의 ‘증권’은? ①證卷 ②證券 ③證權 ④證拳. ‘證券’에 대해 확실하게 알아보자.
...
“비쌀 때에는 개똥같이 여겨 팔아버리고,  값쌀 때에는 주옥같이 여겨 사들이어라!’

貴出如糞土 귀출여분토, 賤取如珠玉 천취여주옥 - ‘史記’ㆍ貨殖列傳.

【添言】 (위에서 보았듯이) 한자는 생각을 많이 하게 합니다.
