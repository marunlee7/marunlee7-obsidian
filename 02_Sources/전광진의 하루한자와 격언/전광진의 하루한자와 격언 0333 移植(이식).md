---
raw_published: "데스크  | 입력 :  2019/04/24 [08:05]"
published:
aliases: ["전광진 교수의 '하루한자와 격언'[333 移植(이식)"]
title: 전광진의 하루한자와 격언 0333 移植(이식)
level: T02
...
priority: "medium"
process: "raw"
source_name: 전광진의 하루한자와 격언 0333 移植(이식)
source_author: "전광진"
source_type: article
action_required: deep_dive
difficulty: good
satisfaction: 3
references: "https://www.ggdaily.kr/sub_read.html?uid=87545&section=sc66&section2="
...
‘이식이 잘된 나무같이 그는 서울 생활에 뿌리를 잘 내렸다’의 ‘이식’은? ①移植 ②利殖 ③利息 ④移殖. ‘移植’이란?
...
移植은 ‘옮겨\[移\] 심음\[植\]’, ‘생체(生體)의 일부 조직을 다른 부위에 옮겨 붙임’을 이른다.

그런데 옮기지 말아야할 것이 있다. 

‘노여움일랑 남에게 옮기지 말고, 같은 잘못일랑 거듭하지 말라’

(不遷怒 불천노, 不貳過 불이과- ‘論語논어’).
