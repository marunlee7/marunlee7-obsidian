---
raw_published: "데스크  | 입력 :  2019/06/12 [08:47]"
published:
aliases: ["전광진 교수의 '하루한자와 격언'[374 募兵(모병)"]
title: 전광진의 하루한자와 격언 0374 募兵(모병)
level: T02
...
priority: "medium"
process: "raw"
source_name: 전광진의 하루한자와 격언 0374 募兵(모병)
source_author: "전광진"
source_type: article
action_required: link_to_t04
difficulty: good
satisfaction: 3
references: "https://www.ggdaily.kr/sub_read.html?uid=88124&section=sc66&section2="
...
‘지원자를 모집(募集)하여 군무에 종사하게 하는 제도’를 이르는 군사용어는? ①徵兵 ②募兵 ③用兵 ④皆兵. 정답이 ‘募兵’임을 알자면 하나하나 뜯어봐야?
...
募兵은 ‘병사(兵士)를 모집(募集)함’이 속뜻이며, 개병(皆兵)의 반대말이다. 문제는 남이 아니라 자기 자신이다.

왜냐하면, ‘남을 착하게 대하면  형제같이 친해지지만,  악하게 대하면  무기를 든 사람보다 더 무서워진다.’

(善氣迎人 선기영인, 親如兄弟친여형제;  惡氣迎人악기영인, 害於戈兵해어과병 - 管子관자).
